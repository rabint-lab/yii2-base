...
class locality
{
    ...
    /**
     * convert persian char to arabic
     * @param string $content
     * @return string
     * @since 5.0.0
     * @see wp-jalali 4.5.3 inc\yk-core.php 44
     */
    public static function persianToArabic($content)
    {
        return str_replace(array('ی', 'ک', '۴', '۵', '۶', 'ه'), array('ي', 'ك', '٤', '٥', '٦', 'ة'), $content);
    }
     ...
     * @param $string
     * @return string
     * @deprecated use  persianToArabic instead
     */
    public static function farsiToArabic($string)
    {
        return static::persianToArabic($string);
    }

    /**
     * @param $string
     * @return string
     * @deprecated use arabicToPersian instead
     */
    public static function arabicToFarsi($string)
    {
        return static::arabicToPersian($string);
    }
