function MapInputWidgetManager()
{
    ...
    const widgetSelector = '.rabint-map-input-widget';
...
function MapInputWidget ( widget )
{
    ...
    const inputSelector = 'input.rabint-map-input-widget-input';

    const searchBarSelector = 'input.rabint-map-input-widget-search-bar';

    const canvasSelector = 'div.rabint-map-input-widget-canvas';
