...
$pageClass = $pageClass ?? ' sidebar-o sidebar-inverse enable-page-overlay side-scroll page-header-fixed page-header-modern ';
...
<div id="page-container" class="<?= $pageClass; ?>">
    ...
    <?= $this->render('_element/overlay', ['this', $this]) ?>
    <?= $this->render('_element/sidebar', ['this', $this]) ?>
    <?= $this->render('_element/header', ['this', $this]) ?>
