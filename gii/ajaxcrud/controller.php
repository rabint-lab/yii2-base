 ...
 */
class <?= $controllerClass ?> extends \rabint\controllers\AdminController
{
    /**
     * @inheritdoc
     */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'footer'=> Html::button(<?= $generator->generateString('Close');?>,['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                            Html::a('Edit',[<?= $generator->generateString('update');?>,'<?= substr($actionParams,1) ?>'=><?= $actionParams ?>],['class'=>'btn btn-primary','role'=>'modal-remote'])
                ];
            }else{
                 return [
                    'title'=> <?= $generator->generateString("Update $modelClass"). ".'#'.". $actionParams; ?>,
